...
class SignInForm extends Component {
    ...
    onSubmit = event => {
        ...
        //     .then(authUser => {
                ...
                if (email === "abhis6307@gmail.com" && password === "absk123") {
                ...
                <div className="row" style={{ minHeight: "88vh" }}>
                    <div className="col-sm-12 col-md-6" style={areaPadding}>
                        <div className="landing">
                            ...
                            <span>Student Manager which takes note of all your student details</span>
                            <hr />
                            <p> Sign up to create an account - and start managing your profile </p>
                            <hr />
